...
# There is a lot of info in the R output above. Most importantly you can see that there is an summary effect size of 0.0343 representing differences between patients and controls. Also this difference is statistically insignificant with a p=0.9337. In order to visualize the results you can create a forest-plot using the forest() function.
