...
df_freq <- df %>% 
    select(c(ArticleID, StudyID, Title, Authors, Year_publication, Article, SAMPLE_SIZE_HC, SAMPLE_SIZE_SZ, frequency, PITCH_F0_HC_M, PITCH_F0_HC_SD,PITCH_F0_SZ_M,PITCH_F0_SZ_SD)) %>% drop_na %>% 
    filter(frequency == "hz")
